package net.groenenhaag.tutorialmod.networking;

import net.groenenhaag.tutorialmod.TutorialMod;
import net.groenenhaag.tutorialmod.networking.packet.DrinkWaterC2SPacket;
import net.groenenhaag.tutorialmod.networking.packet.ExampleC2SPacket;
...
public class ModMessages {
    ...
    public static void register() {
        SimpleChannel net = NetworkRegistry.ChannelBuilder.named(new ResourceLocation(TutorialMod.MOD_ID,
                "messages")).networkProtocolVersion(() -> "1.0")
        ...
        net.messageBuilder(ThirstDataSyncS2CPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
                ...
                .consumerMainThread(ThirstDataSyncS2CPacket::handle).add();
    }
